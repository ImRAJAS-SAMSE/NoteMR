...
class Img2PromptVQA(BaseModel):
    ...
    def forward_cap(
        ...
        while min_num_captions < num_captions:
            ...
            stacked = torch.stack(encoder_out_samples, dim=1)  #1,50,20,1024
    ...
    def from_config(cls, model_config):
        ...
        # )
        question_generation_tokenizer = T5Tokenizer.from_pretrained(
            "/data/fangwenlong/t5-large-lm-adapt"
        )
        ...
        #     progress=True,
        # )
        cached_file = "/data/fangwenlong/LAVIS-main/LAVIS-main/T5_large_QG.pth"
