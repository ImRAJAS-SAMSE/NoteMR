...
class FLMRModelForRetrieval(FLMRPretrainedModelForRetrieval):
    ...
    def query(
        ...
        # print(concat_output_from_vision_encoder)  True
        # print(concat_output_from_text_encoder) True
        ...
        # print(hasattr(text_encoder_outputs, "hidden_states"))
